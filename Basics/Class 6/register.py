...
initialize the fields of the entry: id, name, age, city, potato_count
create two methods:
   form_entry( id, name, age, city, potato):
       responsible for returning formed entry data.
   get_user_data -> collecting the data from userInput
:
